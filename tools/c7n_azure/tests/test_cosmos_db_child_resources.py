...
from c7n_azure.resources.cosmos_db_child_resources import CosmosDBChildResource
from c7n_azure.session import Session


class CosmosDBChildResourcesTest(BaseTest):
...
class CosmosDBReplaceOfferActionTest(BaseTest):
    ...
    def test_replace_offer_collection_action(self):
        ...
        self.initial_offer = collections[0]['c7n:offer']
